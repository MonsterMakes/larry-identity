'use strict';
const namespace = 'api.larry-identity-api';
...
process.on('unhandledRejection', (reason, p) => {
	...
	log.error(`Api Server (larry-identity-api) exiting due to unhandledRejection...`);
	process.exit(1);
});
process.on('uncaughtException', (err) => {
	log.error('Uncaught Exception:', err);
	log.error(`Api Server (larry-identity-api) exiting due to uncaughtException...`);
	process.exit(1);
});
/*************************************************************************************/
